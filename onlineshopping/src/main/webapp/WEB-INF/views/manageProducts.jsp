				...
				<div class="panel-body">
					...
					<sf:form class="form-horizontal" modelAttribute="product"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea path="description" id="description" rows="4" placeholder="Write a product description" class="form-control"></sf:textarea>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:select class="form-control" id="categoryId" path="categoryId" items="${categories}" itemLabel="name" itemValue="id"></sf:select>
